...
The mechanism of \textbf{on-target cisplatin resistance} is believed to arise in particular with the removal of cisplatin DNA-adducts and subsequent apoptosis can be defective in cisplatin-resistant cancer cells due to a variety of mechanisms including \ac{NER} proficiency \cite{wood2000dna, shuck2008eukaryotic}. In addition to the main summary list in \textbf{table 1.2}, another proposed mechanism for cisplatin resistance involves high expression of the high-mobility group box protein 1 (HMGB1) . HMGB1 appears to bind selectively to cisplatin DNA crosslinks and interferes with \ac{NER} while HMGB3 is associated with the promoter regions of ATR and CHK1 \cite{awuah2017repair, ukherjee2019targeting}. 
...
\subsection{G4-quadruplex stabilizers}
Needs correction: From grant: Outside the specific instance of HR deficiency which is more prevalent in TNBC, there are no pathway specific approved treatments. Immunotherapy in unselected TNBC patients has been disappointing to date
59–61 
The dominant feature of the p53/basal expression group is genomic instability. This leads to the questions, what processes result in TNBC genomic instability and do they identify specific subgroups that could be targeted through synthetic lethal approaches, analogous to PARP inhibitors that exploit loss of homologous recombination repair (HR).
We 62 and others. 63,64 have also recently described G-quadruplex (“at risk” DNA structures) binding
drug (CX-5461) synthetic lethality in HR (BRCA1/2) deficient tumours, resulting in a first in
human Canadian clinical trial (CCTG-IND231) that we are leading. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
