...
\section{Statistical models to measure clonal fitness}
The two key statistical innovations required to identify and measure  clonal fitness are first of all to find their relationships, a Bayesian phylogenetic inference method, \textbf{Sitka} that scales to thousands of cells for copy number states in scWGS and adaptation of a birth death process statistical model, and  \textbf{Wright-Fisher diffusion}, to scWGS genotypes, named as \texttt{fitClone}.

\subsection{Introduction to Sitka application on single cell data}
