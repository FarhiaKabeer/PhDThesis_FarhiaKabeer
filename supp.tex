...
% Deterministic model - logistic growth, the limit of the dynamic when Ne -> Inf (could \cite{rousseau2017estimating}
...
%\subsection{sfig\_pdxExpDesCurves}
%\subsection{fig\_S2\_sfig\_MixRxDesCurves}
%\subsection{Summary sequencing figures}
