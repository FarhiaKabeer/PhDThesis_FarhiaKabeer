...
\examiningcommittee{Dr. Samuel Aparicio, Pathology and Laboratory Medicine, UBC }%
    {Supervisor}
    \examiningcommittee{Dr. David Huntsman, Pathology and Laboratory Medicine, UBC}%
    {Supervisory Committee Member}
\examiningcommittee{Dr. Wan Lam, Pathology and Laboratory Medicine, UBC}%
    {University examiner}
 \examiningcommittee{Dr. Brad Nelson, Medical Genetics, UBC}%
    {University examiner}



% details of your supervisory committee
\supervisorycommittee{Dr. Sohrab Shah, Chief of Computational Oncology, Memorial Sloan Kettering Cancer Centre}%
{Supervisory Committee Member}
\supervisorycommittee{Dr. Fran\c{c}ois B\'enard, Radiology (Functional Cancer Imaging), UBC}{Supervisory Committee Member}
