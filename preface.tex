...
From the drug efficacy \textit{in vitro} cultures, few experiments contributed to the \textit{Nature Communication, 2017} paper \cite{xu2017cx}:
...
The last half of chapter 3 is based on \textit{Genome biology} paper \cite{o2019dissociation}:
