...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{Figures/SA535combinebarplotspdf.pdf}
...
\caption[Combined data analysis of SA535 with cisplatin and CX-5461]
	...
	\textbf{Combined data analysis of SA535 with cisplatin and CX-5461.}
	    ...
	    \textbf{(a)} Bar plots showing clonal composition at each time point. Vertical axis shows the clonal frraction   and horizontal axis presents the passage timepoint.
	     \textbf{(b)} Simplified way to present clonal lineage tree matching the bars composition in \textbf{(a)}.
	}
	\label{fig:SA535combinebarplotspdf}
\end{figure}
