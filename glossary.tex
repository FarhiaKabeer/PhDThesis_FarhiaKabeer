...
\acro{IP}{intraperitoneal}
\acro{TNBC}{triple negative breast cancer}
\acro{Q3Dx8}{every third day for 8 doses maximum}
...
\acro{TGI}{tumor growth inhibition}
...
\acro{UMIs}{unique molecular identifiers}
